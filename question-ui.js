(function(){
  ...
  function render(question,{mount,input}={}){
    ...
    else if(kind==='gates'){if(ui.inputs)genericCards(root,ui.inputs,'INPUT');if(ui.gates)genericCards(root,ui.gates,'GATE');if(ui.outputOrder)root.append(el('p','qv-note',`Output order: ${ui.outputOrder}`))}
